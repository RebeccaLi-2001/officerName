...
var total = humanOfficers.count
print(total)

// Q1: What percentage of humans are female?
var femaleHuman = humanOfficers.filter{femaleOfficers.contains($0)}.count
print(Float(femaleHuman)/Float(total))



// Q2: How many first officers are human?
var FirstHumanOfficer = firstOfficers.keys.filter{humanOfficers.contains($0)}.count
print(FirstHumanOfficer)


// Q3: Get a list of females sorted by name
let allFemalesAlpha = femaleOfficers.sorted()
print(allFemalesAlpha)
...
print(vulcanFirstOfficers.filter{ officerName in officerName.count < 5}.count)
